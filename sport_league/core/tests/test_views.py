...
class TestRankingView(TestCase):
    def setUp(self):
        ...
        Game.objects.create(home_team=Team.objects.get(name='Barcelona'), home_team_score=2,
                            away_team=Team.objects.get(name='Real Madrid'), away_team_score=1)
        Game.objects.create(home_team=Team.objects.get(name='Real Madrid'), home_team_score=3,
                            away_team=Team.objects.get(name='Barcelona'), away_team_score=2)
...
class GameListCreateAPIViewTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.game = Game.objects.create(home_team=self.team1, away_team=self.team2,
